...
CREATE TABLE `aioveu_material` (
                                   `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '物资ID',
...
INSERT INTO `aioveu_material` (
    ...
    supplier_id, min_stock, max_stock, barcode
      ...
      -- 清洁用品类
      ('洗手液', 22, '瓶', '500ml/抑菌', 18.00, 2004, 30, 150, '7045678901234'),
      ('消毒湿巾', 22, '包', '80片/桶装', 25.00, 2004, 50, 300, '7056789012345'),
      ('垃圾袋', 22, '卷', '大号/50个', 15.00, 2004, 100, 500, '7067890123456'),
      ('空气清新剂', 22, '罐', '300ml/柠檬味', 22.00, 2004, 20, 100, '7078901234567'),

      -- 工具设备类
      ('电动螺丝刀', 23, '把', '12V/锂电', 199.00, 2005, 10, 50, '7089012345678'),
      ('万用表', 23, '台', '数字/自动量程', 150.00, 2005, 5, 30, '7090123456789'),
      ('安全帽', 23, '顶', 'ABS材质/黄色', 35.00, 2005, 50, 200, '7101234567890'),
      ('工具箱', 23 ,'套', '32件套', 280.00, 2005, 8, 40, '7112345678901');